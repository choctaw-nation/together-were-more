...
<section class="front-page-hero hero position-relative overflow-hidden py-5 d-flex flex-column align-items-stretch justify-content-center">
	...
	<figure class="mb-0 ratio ratio-1x1 text-white border border-light border-2 rounded-circle position-absolute bottom-0 start-50 translate-middle z-2 overflow-hidden" id="scroll-down-icon"
