...
- Breaking: Switch to Autoload
- Refactored: Code is re-architected to follow layered architecture pattern
- Updated: Migrated default styles from theme.json settings to styles
- Updated: Packages got upgraded & semver is in sync with theme
